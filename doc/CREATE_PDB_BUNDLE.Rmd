...
below stops before writing if they are unchecked or failed. Write the data and
model first, then the posterior. The reference-draw writer requires that
posterior to exist in the target database before it writes the draws:
