...
writer does not emit a `likelihood_code` entry. A Stan-only implementation is
written with `pymc: null`; the writer does not add `pymc_version`. The bundle
API does not currently provide a way to set a minimum `stan_version`, so that
